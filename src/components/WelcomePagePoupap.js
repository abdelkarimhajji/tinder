...
{
    return (
        <div className="fixed flex flex-col justify-center items-center z-[2] w-[100%] h-screen bg-black/50">
            <div className="w-[450px] h-[500px] bg-white opacity-none text-black rounded-lg flex flex-col items-center jsutify-center">
